...
{
    /// <inheritdoc />
    public sealed class DocumentUpdateRequestStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::JasperAI.DocumentUpdateRequestStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::JasperAI.DocumentUpdateRequestStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}

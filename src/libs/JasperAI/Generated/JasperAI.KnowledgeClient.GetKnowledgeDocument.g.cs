...
namespace JasperAI
{
    public partial class KnowledgeClient
    {
        ...
        private static readonly global::JasperAI.EndPointSecurityRequirement s_GetKnowledgeDocumentSecurityRequirement0 =
        ...
        private static readonly global::JasperAI.EndPointSecurityRequirement[] s_GetKnowledgeDocumentSecurityRequirements =
            new global::JasperAI.EndPointSecurityRequirement[]
            {                s_GetKnowledgeDocumentSecurityRequirement0,
            };
        partial void PrepareGetKnowledgeDocumentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string knowledgeId);
        partial void PrepareGetKnowledgeDocumentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string knowledgeId);
        partial void ProcessGetKnowledgeDocumentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetKnowledgeDocumentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::JasperAI.KnowledgeItemResponse> GetKnowledgeDocumentAsync(
            string knowledgeId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::JasperAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::JasperAI.AutoSDKHttpResponse<global::JasperAI.KnowledgeItemResponse>> GetKnowledgeDocumentAsResponseAsync(
            string knowledgeId,
            global::JasperAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetKnowledgeDocumentArguments(
            ...
            var __authorizations = global::JasperAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetKnowledgeDocumentSecurityRequirements,
                operationName: "GetKnowledgeDocumentAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::JasperAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::JasperAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetKnowledgeDocumentAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetKnowledgeDocumentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::JasperAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::JasperAI.ErrorResponse? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::JasperAI.ErrorResponse.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::JasperAI.ApiException<global::JasperAI.ErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetKnowledgeDocumentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::JasperAI.AutoSDKHttpResponse<global::JasperAI.KnowledgeItemResponse>(
                                        statusCode: __response.StatusCode,
                                ...
                                {
                                    throw global::JasperAI.ApiException.Create(
                                        statusCode: __response.StatusCode,

...
namespace JasperAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::JasperAI.AutoSDKRetryOptions Retry { get; set; } = new global::JasperAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::JasperAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::JasperAI.IAutoSDKHook>();
        ...
        public global::JasperAI.AutoSDKClientOptions AddHook(
            global::JasperAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::JasperAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::JasperAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::JasperAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::JasperAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::JasperAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::JasperAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::JasperAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::JasperAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::JasperAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::JasperAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::JasperAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::JasperAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::JasperAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::JasperAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::JasperAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::JasperAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::JasperAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::JasperAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::JasperAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::JasperAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::JasperAI.IAutoSDKHook, global::JasperAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::JasperAI.AutoSDKHookContext context)
        {

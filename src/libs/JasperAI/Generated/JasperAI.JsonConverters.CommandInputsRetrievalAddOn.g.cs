...
{
    /// <inheritdoc />
    public sealed class CommandInputsRetrievalAddOnJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::JasperAI.CommandInputsRetrievalAddOn>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::JasperAI.CommandInputsRetrievalAddOnExtensions.ToValueString(value));
        }
    }
}

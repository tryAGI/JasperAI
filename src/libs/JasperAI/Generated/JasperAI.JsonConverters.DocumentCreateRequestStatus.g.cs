...
{
    /// <inheritdoc />
    public sealed class DocumentCreateRequestStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::JasperAI.DocumentCreateRequestStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::JasperAI.DocumentCreateRequestStatusExtensions.ToValueString(value));
        }
    }
}
